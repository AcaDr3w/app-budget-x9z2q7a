...
- **Sezione centrale 50/50**: `.anomaly-carousel` + `.savings-card` entrambi `flex:1 1 0; min-height:0` (metà altezza ciascuno). Sparkline anomalie compatta `clamp(44px, 10vh, 84px)`.
